class RoundRobin:
    def processData(self, no_of_processes):
        ...
        for i in range(no_of_processes):
            ...
            temporary.extend([process_id, arrival_time, burst_time, 0, burst_time]) # [0] means not executed and [1] means execution complete: current state of the process
    ...
    def schedulingProcess(self, process_data, quantum_time):
        ...
        while 1:
            ...
            if len(ready_queue) != 0:
                # If process's Remaining Burst Time is > that the Quantum Time, it executes until the end of quantum time then switch
